...
const CrudFunction = () => {
    ...
    function handleAddNewUser() {
        ...
        console.log("Updated array with second object", users)
    }
    ...
    return (
        ...
        <div className="App">
          ...
          <button onClick={handleAddNewUser} style={{backgroundColor:'green', border:'solid 5px black'}}>Add new user</button>
        </div>
      );
}
